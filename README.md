...
```
cd existing_repo
git remote add origin https://gitlab.com/pub-back-end/authentication-manager.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/pub-back-end/authentication-manager/-/settings/integrations)
